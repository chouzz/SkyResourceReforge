...
public class ModItems {
    ...
    public static final DeferredItem<Item> NETHER_BRICK_CONDENSER = ITEMS.register("nether_brick_condenser",
            () -> new Item(new Item.Properties()));

    public static final DeferredItem<Item> NETHER_BRICK_COMBUSTION_HEATER = ITEMS.register("nether_brick_combustion_heater",
            () -> new Item(new Item.Properties()));
