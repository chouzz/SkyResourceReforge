...
public class CondenserRecipeCategory implements IRecipeCategory<ProcessRecipe> {
    ...
    public mezz.jei.api.recipe.RecipeType<ProcessRecipe> getRecipeType() {
        return SkyResourceJEIPlugin.CONDENSER_TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("jei.skyresourcereforge.recipe.condenser");
    }
