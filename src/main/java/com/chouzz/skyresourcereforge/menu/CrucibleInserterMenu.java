...
public class CrucibleInserterMenu extends AbstractContainerMenu {
    private final ContainerLevelAccess access;

    public CrucibleInserterMenu(int containerId, Inventory playerInventory, FriendlyByteBuf data) {
        this(containerId, playerInventory, ContainerLevelAccess.NULL, new ItemStackHandler(1));
    }

    public CrucibleInserterMenu(int containerId, Inventory playerInventory, ContainerLevelAccess access, IItemHandler inventory) {
