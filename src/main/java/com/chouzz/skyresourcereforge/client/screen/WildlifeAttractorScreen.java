...
public class WildlifeAttractorScreen extends AbstractContainerScreen<WildlifeAttractorMenu> {
    ...
    public WildlifeAttractorScreen(WildlifeAttractorMenu menu, Inventory playerInventory, Component title) {
