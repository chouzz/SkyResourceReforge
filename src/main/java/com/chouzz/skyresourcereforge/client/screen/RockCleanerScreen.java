...
import com.chouzz.skyresourcereforge.menu.RockCleanerMenu;
...
public class RockCleanerScreen extends AbstractContainerScreen<RockCleanerMenu> {
    ...
    public RockCleanerScreen(RockCleanerMenu menu, Inventory playerInventory, Component title) {
