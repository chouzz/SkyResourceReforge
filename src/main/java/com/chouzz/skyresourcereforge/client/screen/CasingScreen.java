...
import com.chouzz.skyresourcereforge.menu.CasingMenu;
...
public class CasingScreen extends AbstractContainerScreen<CasingMenu> {
    ...
    public CasingScreen(CasingMenu menu, Inventory playerInventory, Component title) {
